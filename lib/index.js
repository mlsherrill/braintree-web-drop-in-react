          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                this.instance.on("validityChange", function () {
                  if (_this2.props.onValidityChange) {
                    var _this2$props6;

                    (_this2$props6 = _this2.props).onValidityChange.apply(_this2$props6, arguments);
                  }
                });
...
(0, _defineProperty2["default"])(DropIn, "propTypes", {
  ...
  onValidityChange: _propTypes["default"].func
});
